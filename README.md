...
We love to use nested sampling with the [Earth Horizon Telescope (EHT)](http://eventhorizontelescope.org/), but it is rather annoying to constantly write the prior transformation. This package will do that for you. It does this by first looking at the types of the 
